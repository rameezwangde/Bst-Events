...
const Gallery = () => {
  ...
  return (
    <Layout>
      <section className="bg-bst-dark text-white py-24 relative overflow-hidden">
          ...
          <div className="flex justify-center gap-4 mb-16 flex-wrap">
            {CATEGORIES.map((cat, i) => (
              <motion.button
                ...
                className={`px-8 py-3 rounded-full text-sm font-bold transition-all duration-300 tracking-wide ${filter === cat
